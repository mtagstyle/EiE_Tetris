...
#define LCD_IMAGE_CHARACTER_HEIGHT        (u8)12
#define LCD_IMAGE_CHARACTER_WIDTH         (u8)12
#define LCD_IMAGE_CHARACTER_COL_BYTES     (u8)((LCD_IMAGE_CHARACTER_WIDTH * LCD_PIXEL_BITS / 8)+1)
/*******************************************************************************
* Bookmarks
********************************************************************************
